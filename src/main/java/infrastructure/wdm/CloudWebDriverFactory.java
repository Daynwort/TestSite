...
public class CloudWebDriverFactory implements WebDriverFactory {
    ...
    public WebDriver create() {
        ...
        try {
            driver =  new RemoteWebDriver(new URL(ConfigurationManager.getInstance().getRemoteServerName() + ConfigurationManager.getInstance().getUserName() +
                    ConfigurationManager.getInstance().getUserPassword() + ConfigurationManager.getInstance().getRemoteHubUrl()), caps);
